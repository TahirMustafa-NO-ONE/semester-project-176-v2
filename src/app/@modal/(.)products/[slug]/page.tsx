    ...
    async function fetchProduct() {
      try {
        const res = await fetch(
          `https://sparkling-creativity-3a00661c57.strapiapp.com/api/products?filters[slug][$eq]=${resolvedParams.slug}&populate[category]=true&populate[image]=true`
        );
          ...
          <DialogHeader className="w-full h-full">
            <div className="flex flex-col lg:flex-row w-full h-full">
              ...
              <div className="relative w-full lg:w-1/2 h-[40vh] lg:h-[600px] flex-shrink-0">
                <div className="absolute inset-0 bg-gray-100" /> {/* Placeholder background */}
                <Image
                  src={imageUrl}
                  alt={product.title}
                  fill
